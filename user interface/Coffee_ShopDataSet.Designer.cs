...
namespace user_interface.Coffee_ShopDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([P_ID] = @Original_P_ID) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ((@IsNull_pname = 1 AND [pname] IS NULL) OR ([pname] = @Original_pname)))";
...
SELECT P_ID, price, description, pimage, pname FROM Product WHERE (P_ID = @P_ID)";
        ...
        public virtual int Fill(Coffee_ShopDataSet.ProductDataTable dataTable) {
        ...
        public virtual Coffee_ShopDataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Coffee_ShopDataSet.ProductDataTable dataTable = new Coffee_ShopDataSet.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Coffee_ShopDataSet.ProductDataTable dataTable) {
